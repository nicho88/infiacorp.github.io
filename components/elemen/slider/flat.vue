      ...
      >
        <div v-for="(item, index) in list" :key="'key1' + index" class="w-full">
          <div class="overflow-hidden relative">
            ...
            <div class="bg-warna001 pb-10 pt-12">
              <div class="container mx-auto">
                <div class="">
                  <div class="mb-3 mt-10" v-if="item.brandImage">
                    <img :src="item.brandImage" class="h-[40px] object-cover" />
                  </div>

                  <div
                    class="text-md md:text-[64px] font-bold text-white font-trickster mb-7"
                    v-html="item.title"
                  ></div>
                  <div
                    class="text-sm md:text-[32px] font-bold text-white font-acumin mb-7"
                    v-if="item.subTitle"
                  >
                    {{ item.subTitle }}
                  </div>
                  ...
                  <div
                    class="text-white mb-5 w-full md:w-1/2 font-acumin text-[22px] desc-konten"
