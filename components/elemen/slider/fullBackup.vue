    ...
    <client-only>
      ...
      >
        <div v-for="(item, index) in list" :key="'key1' + index" class="w-full">
          <div class="relative bg-warna001">
            <div class="h-[100px]"></div>
            <div class="container mx-auto flex justify-end">
              <img :src="item.image" :alt="item.title" class="mt-0 md:-mt-10" />
            </div>
            <div
              class="md:absolute bottom-0 left-0 top-0 right-0 p-3 flex items-end"
            >
              <div class="container mx-auto">
                <div class="">
                  ...
                  <div
                    class="text-white text-md mb-5 w-full md:w-1/2 font-acumin text-[22px]"
                  >
                    {{ item.description }}
                  </div>
                </div>
