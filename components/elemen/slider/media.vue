    ...
    <client-only>
      ...
      >
        <div v-for="(item, index) in list" :key="'key1' + index" class="w-full">
          ...
          <div class="bg-warna001 pb-10 pt-[80px] relative">
            <div class="container">
              <h1
              ...
              />
              <h2
                class="text-sm md:text-[32px] md:w-[60%] leading-normal font-bold text-white font-acumin mb-5"
            ...
            <div class="md:absolute top-0 bottom-0 right-0 z-10">
              <img
                :src="item.path + item.id + '/bg.png'"
                :alt="item.title"
                height="500"
                class="md:h-[500px] md:-translate-y-[10%] z-10"
              />
            </div>
          </div>
          <div class="">
